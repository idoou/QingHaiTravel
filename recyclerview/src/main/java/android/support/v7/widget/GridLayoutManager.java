...
/**
 * A {@link RecyclerView.LayoutManager} implementations that lays out items in a
 * grid.
 * <p>
 * By default, each item occupies 1 span. You can change it by providing a
 * custom {@link SpanSizeLookup} instance via
 * {@link #setSpanSizeLookup(SpanSizeLookup)}.
 */
public class GridLayoutManager extends LinearLayoutManager {
    ...
    /**
     * Sets the source to get the number of spans occupied by each item in the
     * adapter.
     * 
     * @param spanSizeLookup {@link SpanSizeLookup} instance to be used to query
     *            number of spans occupied by each item
     */
     ...
     * <p>
     * If {@link #getOrientation()} is {@link #VERTICAL}, this is the number of
     * columns. If {@link #getOrientation()} is {@link #HORIZONTAL}, this is the
     * number of rows.
     * 
    ...
    public static abstract class SpanSizeLookup {
         ...
         * @return The number of spans occupied by the item at the provided
         *         position
         */
        abstract public int getSpanSize(int position);

        /**
         * Sets whether the results of {@link #getSpanIndex(int, int)} method
         * should be cached or not. By default these values are not cached. If
         * you are not overriding {@link #getSpanIndex(int, int)}, you should
         * set this to true for better performance.
         * 
         * @param cacheSpanIndices Whether results of getSpanIndex should be
         *            cached or not.
         */
        ...
        /**
         * Clears the span index cache. GridLayoutManager automatically calls
         * this method when adapter changes occur.
         */
        ...
        /**
         * Returns whether results of {@link #getSpanIndex(int, int)} method are
         * cached or not.
         * 
         * @return True if results of {@link #getSpanIndex(int, int)} are
         *         cached.
         */
         ...
         * <p>
         * If you have a faster way to calculate span index for your items, you
         * should override this method. Otherwise, you should enable span index
         * cache ({@link #setSpanIndexCacheEnabled(boolean)}) for better
         * performance. When caching is disabled, default implementation
         * traverses all items from 0 to <code>position</code>. When caching is
         * enabled, it calculates from the closest cached value before the
         * <code>position</code>.
         * <p>
         * If you override this method, you need to make sure it is consistent
         * with {@link #getSpanSize(int)}. GridLayoutManager does not call this
         * method for each item. It is called only for the reference item and
         * rest of the items are assigned to spans based on the reference item.
         * For example, you cannot assign a position to span 2 while span 1 is
         * empty.
         * <p>
         * Note that span offsets always start with 0 and are not affected by
         * RTL.
         * 
         * @param position The position of the item
         * @param spanCount The total number of spans in the grid
         * @return The final span position of the item. Should be between 0
         *         (inclusive) and <code>spanCount</code>(exclusive)
         */
         ...
         * <p>
         * For example, if grid has 3 columns and each item occupies 1 span,
         * span group index for item 1 will be 0, item 5 will be 1.
         * 
         * @param adapterPosition The position in adapter
         * @param spanCount The total number of spans in the grid
         * @return The index of the span group including the item at the given
         *         adapter position
         */
    ...
    /**
     * Default implementation for {@link SpanSizeLookup}. Each item occupies 1
     * span.
     */
    ...
    public static class LayoutParams extends RecyclerView.LayoutParams {
        ...
        /**
         * Returns the current span index of this View. If the View is not laid
         * out yet, the return value is <code>undefined</code>.
         * <p>
         * Note that span index may change by whether the RecyclerView is RTL or
         * not. For example, if the number of spans is 3 and layout is RTL, the
         * rightmost item will have span index of 2. If the layout changes back
         * to LTR, span index for this view will be 0. If the item was occupying
         * 2 spans, span indices would be 1 and 0 respectively.
         * <p>
         * If the View occupies multiple spans, span with the minimum index is
         * returned.
         * 
        ...
        /**
         * Returns the number of spans occupied by this View. If the View not
         * laid out yet, the return value is <code>undefined</code>.
         * 
