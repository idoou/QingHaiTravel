 ...
 * <p>
 * It wraps a RecyclerView and adds ability to hide some children. There are two
 * sets of methods provided by this class. <b>Regular</b> methods are the ones
 * that replicate ViewGroup methods like getChildAt, getChildCount etc. These
 * methods ignore hidden children.
 * <p>
...
class ChildHelper {
     ...
     * @param hidden If set to true, this item will be invisible from regular
     *            methods.
     */
     ...
     * 
     * @param child View to add.
     * @param index Index of the child from the regular perspective (excluding
     *            hidden views). ChildHelper offsets this index to actual
     *            ViewGroup index.
     * @param hidden If set to true, this item will be invisible from regular
     *            methods.
     */
    ...
    private int getOffset(int index) {
        ...
        while (offset < limit) {
            ...
            if (diff == 0) {
                while (mBucket.get(offset)) { // ensure this offset is not
                                              // hidden
                    offset++;
                }
                return offset;
     ...
     * @param hidden If set to true, this item will be invisible to the regular
     *            methods.
     */
     ...
     * @return The regular perspective index of the child or -1 if it does not
     *         exists.
     */
