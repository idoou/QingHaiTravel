...
/**
 * Version 1.0 Date: 2014-07-07 19:53 Author: flzyup@ligux.com Copyright ©
 * 2009-2014 LiGux.com.
 */
public abstract class CursorAdapter<VH extends RecyclerView.ViewHolder> extends
        RecyclerView.Adapter<VH> implements Filterable,
     ...
     * the filter attached to this adapter. The query is provided by a
     * {@link android.widget.FilterQueryProvider}. If no provider is specified,
     * the current cursor is not filtered and returned. After this method
     * returns the resulting cursor is passed to {@link #changeCursor(Cursor)}
     * and the previous cursor is closed. This method is always executed on a
     * background thread, not on the application's main thread (or UI thread.)
