...
class LayoutState {
    ...
    /**
     * Defines the direction in which the data adapter is traversed. Should be
     * {@link #ITEM_DIRECTION_HEAD} or {@link #ITEM_DIRECTION_TAIL}
     */
    int mItemDirection;
     ...
     * rendered for {@link #mExtra} is not considered not to recycle visible
     * children.
     */
    int mExtra = 0;
    ...
    /**
     * Gets the view for the next element that we should render. Also updates
