...
public class StickyHeadersBuilder {
    ...
    public StickyHeadersBuilder setStickyHeadersAdapter(
    ...
    public StickyHeadersBuilder setAdapter(
    ...
    public StickyHeadersBuilder setOnHeaderClickListener(
    ...
    public StickyHeadersItemDecoration build() {
        ...
        HeaderStore store = new HeaderStore(recyclerView,
                headersAdapter, isSticky);

        StickyHeadersItemDecoration decoration = new StickyHeadersItemDecoration(
                store, overlay,
                drawOrder);
        ...
        if (headerClickListener != null) {
            StickyHeadersTouchListener touchListener = new StickyHeadersTouchListener(
                    recyclerView,
                    store);
