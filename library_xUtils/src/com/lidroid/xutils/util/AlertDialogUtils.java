...
public class AlertDialogUtils {
    ...
    /**
     * 展现简单的一个按钮的alert框，类似网页alert 带事件
     * 
     * @param title
     * @param message
     * @param buttonText
     */
    public static void displayAlert(Context context, String title, String message, String buttonText ,DialogInterface.OnClickListener buttonOnclick) {
        AlertDialog alertDialog = new AlertDialog.Builder(context)
                .setPositiveButton(buttonText, buttonOnclick).setTitle(title).setMessage(message).create();
