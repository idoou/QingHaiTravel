...
import com.ziyou.selftravel.app.ServerAPI.LiveVideos;
import com.ziyou.selftravel.data.RequestManager;
import com.ziyou.selftravel.data.SoapRequest;
import com.ziyou.selftravel.data.SoapRequest.Listener;
import com.ziyou.selftravel.model.LiveServerInfo;
...
//        }
        ...
        // String url1 =
        // "rtsp://117.27.130.118:554/service?UserId=A8766406A84B195456BDC16F06813135&PuId-ChannelNo=140502000180000195-1&PuProperty=1&VauPtzAdd=120.33.35.220&VauPtzPort=5062&VauRtspAdd=120.33.35.220&VauRtspPort=554&StreamingType=2&hashtoken=6527728e16adadb2";
        // String url2 =
        // "rtsp://117.27.130.118:554/service?UserId=A8766406A84B195456BDC16F06813135&PuId-ChannelNo=140502000204000022-1&PuProperty=1&VauPtzAdd=120.33.35.220&VauPtzPort=5062&VauRtspAdd=120.33.35.220&VauRtspPort=554&StreamingType=2&hashtoken=6b1f66af5d1de954";
//        if (mLiveId > 0) {
//            getLiveServerInfo();
//        } else {
