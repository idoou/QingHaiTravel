...
import static com.ziyou.selftravel.download.Downloads.Impl.ALL_DOWNLOADS_CONTENT_URI;
...
import com.ziyou.selftravel.download.Downloads.Impl.RequestHeaders;
...
public class OpenHelper {
    ...
    public static boolean startViewIntent(Context context, long id, int intentFlags) {
        ...
        if (intent == null) {
            Log.w(Constants.TAG, "No intent built for " + id);
            return false;
        }
