...
import com.ziyou.selftravel.download.DownloadManager.Request;
...
public final class DownloadProvider extends ContentProvider {
    ...
    private static final String[] sAppReadableColumnsArray = new String[] {
            ...
            Downloads.Impl.COLUMN_SCENIC_ID,
            Downloads.Impl.COLUMN_SCENIC_INTRO,
            Downloads.Impl.COLUMN_SCENIC_NAME,
            Downloads.Impl.COLUMN_COVER_IMAGE,
        ...
        private void upgradeTo(SQLiteDatabase db, int version) {
            switch (version) {
                ...
                case 109:
                    ...
                    addColumn(db, DB_TABLE, Downloads.Impl.COLUMN_SCENIC_ID,
                            "INTEGER DEFAULT 0");
                    addColumn(db, DB_TABLE, Downloads.Impl.COLUMN_SCENIC_INTRO,
                            "TEXT");
                    addColumn(db, DB_TABLE, Downloads.Impl.COLUMN_SCENIC_NAME,
                            "TEXT");
                    addColumn(db, DB_TABLE, Downloads.Impl.COLUMN_COVER_IMAGE,
                            "TEXT");
                    addColumn(db, DB_TABLE, Downloads.Impl.COLUMN_CONTENT_PATH,
                            "TEXT");
                    break;
    ...
    public Uri insert(final Uri uri, final ContentValues values) {
        ...
        copyInteger(Downloads.Impl.COLUMN_SCENIC_ID, values, filteredValues);
        copyString(Downloads.Impl.COLUMN_SCENIC_NAME, values, filteredValues);
        copyString(Downloads.Impl.COLUMN_SCENIC_INTRO, values, filteredValues);
        copyString(Downloads.Impl.COLUMN_COVER_IMAGE, values, filteredValues);
            ...
            case ALL_DOWNLOADS_ID:
                ...
                try {
                    while (cursor.moveToNext()) {
                        ...
                        // DownloadStorageProvider.onDownloadProviderDelete(getContext(),
                        // id);
                    }
                } finally {
     ...
     */
    // @Override
    // public ParcelFileDescriptor openFile(final Uri uri, String mode) throws
    ...
    // Downloads.Impl.COLUMN_LAST_MODIFICATION + ">" + modifiedAfter, null,
    // null, null,
