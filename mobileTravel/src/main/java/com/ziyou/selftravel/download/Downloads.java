...
public final class Downloads {
    ...
    public static final String AUTHORITY = "com.ziyou.selftravel";

    /**
     * Implementation details Exposes constants used to interact with the
     * download manager's content provider. The constants URI ... STATUS are the
     * names of columns in the downloads table.
     */
    public static final class Impl implements BaseColumns {
        ...
        public static final Uri CONTENT_URI =
                Uri.parse("content://com.ziyou.selftravel/my_downloads");
        ...
        public static final Uri ALL_DOWNLOADS_CONTENT_URI =
                Uri.parse("content://com.ziyou.selftravel/all_downloads");
        ...
        /**
         * The content URI for accessing publicly accessible downloads (i.e., it
         * requires no permissions to access this downloaded file)
         */
         ...
         * from the database when MediaProvider database also deletes the
         * metadata asociated with this downloaded file.
         * <P>
         * Type: BOOLEAN
         * </P>
         * <P>
         ...
         * downloaded entry. It is used to delete the entries from MediaProvider
         * database when it is deleted from the downloaded list.
         * <P>
         * Type: TEXT
         * </P>
         * <P>
         ...
         * invoked. It can take the values: null or 0(not scanned), 1(scanned),
         * 2 (not scannable).
         * <P>
         * Type: TEXT
         * </P>
        ...
        /**
         * The column with errorMsg for a failed downloaded. Used only for
         * debugging purposes.
         * <P>
         * Type: TEXT
         * </P>
        ...
        /**
         * This column stores the source of the last update to this row. This
         * column is only for internal use. Valid values are indicated by
         * LAST_UPDATESRC_* constants.
         * <P>
         * Type: INT
         * </P>
         */
        ...
        public static final String COLUMN_SCENIC_ID = "scenic_id";
        public static final String COLUMN_SCENIC_NAME = "scenic_name";
        public static final String COLUMN_SCENIC_INTRO = "scenic_intro";
        public static final String COLUMN_COVER_IMAGE = "cover_image";
        public static final String COLUMN_CONTENT_PATH = "content_path";

        /**
         * default value for {@link #COLUMN_LAST_UPDATESRC}. This value is used
         * when this column's value is not relevant.
         */
        public static final int LAST_UPDATESRC_NOT_RELEVANT = 0;

        /**
         * One of the values taken by {@link #COLUMN_LAST_UPDATESRC}. This value
         * is used when the update is NOT to be relayed to the DownloadService
         * (and thus spare DownloadService from scanning the database when this
         * change occurs)
         */
        ...
        /**
         * This download will be saved to the download manager's private
         * partition, as with DESTINATION_CACHE_PARTITION, but the download will
         * not proceed if the user is on a roaming data connection.
         */
        ...
        /**
         * This download will be saved to the system cache ("/cache") partition.
         * This option is only used by system apps and so it requires
         ...
         * @return true if the notification should be displayed. false
         *         otherwise.
         */
    ...
    public static final void removeAllDownloadsByPackage(
        ...
        context.getContentResolver().delete(Impl.CONTENT_URI, QUERY_WHERE_CLAUSE,
                new String[] {
                        notification_package, notification_class
                });
    }
}
