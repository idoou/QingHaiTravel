...
import com.ziyou.selftravel.adapter.SelectedImageAdapter;
...
import com.ziyou.selftravel.model.Author;
...
public class CommentEditActivity extends BaseActivity implements OnClickListener ,UploadTask.UploadCallBack {
    ...
    private void initViews() {
        ...
        final SelectedImageAdapter adpater = new SelectedImageAdapter();
        ...
        switch (v.getId()) {
            ...
            case R.id.action_bar_right:
                if (mRatingBar.getRating() == 0) {
                    Toast.makeText(this, R.string.comment_edit_input_rating, Toast.LENGTH_SHORT)
                            .show();
                } else if (TextUtils.isEmpty(mCommentText.getText().toString().trim())) {
