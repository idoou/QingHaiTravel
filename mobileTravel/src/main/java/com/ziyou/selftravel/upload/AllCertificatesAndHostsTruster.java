...
public class AllCertificatesAndHostsTruster implements TrustManager, X509TrustManager {
    ...
    private static final String SSL_FAILED = "Unable to initialize the Trust Manager to trust all the SSL certificates and HTTPS hosts.";
    ...
    public static void apply() {
        final TrustManager[] trustAllCerts = new TrustManager[] {
                new AllCertificatesAndHostsTruster()
        };
