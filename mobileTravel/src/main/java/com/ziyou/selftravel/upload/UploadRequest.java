...
public class UploadRequest {
     ...
     * @param uploadId unique ID to assign to this upload request. It's used in
     *            the broadcast receiver when receiving updates.
     * @param serverUrl URL of the server side script that handles the multipart
     *            form upload
     */
     ...
     * 
     * @param iconResourceID ID of the notification icon. You can use your own
     *            app's R.drawable.your_resource
     * @param title Notification title
     * @param message Text displayed in the notification when the upload is in
     *            progress
     * @param completed Text displayed in the notification when the upload is
     *            completed successfully
     * @param error Text displayed in the notification when an error occurs
     * @param autoClearOnSuccess true if you want to automatically clear the
     *            notification when the upload gets completed successfully
     */
    public void setNotificationConfig(final int iconResourceID, final String title,
            final String message,
            final String completed, final String error, final boolean autoClearOnSuccess) {
        notificationConfig = new UploadNotificationConfig(iconResourceID, title, message,
                completed, error,
                autoClearOnSuccess);
    }

    /**
     * Validates the upload request and throws exceptions if one or more
     * parameters are not properly set.
     * 
     * @throws IllegalArgumentException if request protocol or URL are not
     *             correctly set
     ...
     * @param parameterName Name of the form parameter that will contain file's
     *            data
     * @param fileName File name seen by the server side script
     * @param contentType Content type of the file. Set this to null if you
     *            don't want to set a content type.
     */
    public void addFileToUpload(final String path, final String parameterName,
    ...
    /**
     * Gets the URL of the server side script that will handle the multipart
     * form upload.
     * 
     * @return
     */
