...
public class PlaybackService extends Service implements MediaPlayer.OnCompletionListener
    ...
    public static final String ACTION_PLAYSTATE_CHANGED = "com.ziyou.selftravel.action.PLAYSTATE_CHANGED";
    public static final String ACTION_META_CHANGED = "com.ziyou.selftravel.action.META_CHANGED";
    public static final String ACTION_LAUNCH_PLAYBACK_ACTIVITY = "com.ziyou.selftravel.action.PLAYBACK_ACTIIVTY";
    public static final String ACTION_TOGGLE_PLAYBACK_NOTIFICATION = "com.ziyou.selftravel.action.TOGGLE_PLAYBACK_NOTIFICATION";
    public static final String ACTION_CLOSE_NOTIFICATION = "com.ziyou.selftravel.action.CLOSE_NOTIFICATION";
