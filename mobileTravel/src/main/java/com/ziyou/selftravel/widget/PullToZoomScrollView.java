...
public class PullToZoomScrollView extends ScrollView {
    ...
    private void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            if (zoomViewResId > 0) {
                mZoomView = mLayoutInflater.inflate(zoomViewResId, this, false);
            ...
            if (headViewResId > 0) {
                mHeadView = mLayoutInflater.inflate(headViewResId, this, false);
            ...
            if (contentViewResId > 0) {
                mContentView = mLayoutInflater.inflate(contentViewResId, this, false);
                    ...
                    if (j == -1) {
                        ...
                        if (mZoomContainer.getBottom() >= mZoomHeight) {
                            ...
                            ViewGroup.LayoutParams headLayoutParams = mHeaderContainer
                                    .getLayoutParams();
                            float f = ((ev.getY(j) - mLastMotionY + mZoomContainer.getBottom())
                                    / mZoomHeight - mLastScale)
                                    / 2.0F + mLastScale;
