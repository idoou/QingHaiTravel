...
public class ExpandableTextView extends LinearLayout implements OnClickListener {
    ...
    private int mMaxCollapsedLines = 2; // The default number of lines;
    ...
    void init() {
        mCollapseDrawable = getResources().getDrawable(R.drawable.ic_arrow_collapse_selecter);
        mExpandDrawable = getResources().getDrawable(R.drawable.ic_arrow_expand_selecter);
    }
