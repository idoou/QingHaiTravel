...
public class CircularProgressBar extends ProgressBar {
    ...
    public CircularProgressBar(Context context, AttributeSet attrs, int defStyle) {
        ...
        final int color = a
                .getColor(R.styleable.CircularProgressBar_cpb_color, res.getColor(R.color.title_bg));
        ...
        CircularProgressDrawable.Builder builder = new CircularProgressDrawable.Builder(context).sweepSpeed(sweepSpeed)
                .rotationSpeed(rotationSpeed).strokeWidth(strokeWidth).minSweepAngle(minSweepAngle)
