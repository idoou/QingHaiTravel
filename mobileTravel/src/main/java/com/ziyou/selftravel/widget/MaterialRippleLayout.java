...
public class MaterialRippleLayout extends FrameLayout {
    ...
    private static final boolean DEFAULT_SUPER_TOUCH = false;
    ...
    public MaterialRippleLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        rippleOverlay = a.getBoolean(R.styleable.MaterialRippleLayout_rippleOverlay,
                DEFAULT_RIPPLE_OVERLAY);
        rippleHover = a.getBoolean(R.styleable.MaterialRippleLayout_rippleHover, DEFAULT_HOVER);
        rippleDuration = a
                .getInt(R.styleable.MaterialRippleLayout_rippleDuration, DEFAULT_DURATION);
        rippleAlpha = (int) (255 * a.getFloat(R.styleable.MaterialRippleLayout_rippleAlpha,
                DEFAULT_ALPHA));
        rippleDelayClick = a.getBoolean(R.styleable.MaterialRippleLayout_rippleDelayClick,
                DEFAULT_DELAY_CLICK);
        rippleFadeDuration = a.getInteger(R.styleable.MaterialRippleLayout_rippleFadeDuration,
                DEFAULT_FADE_DURATION);
        rippleBackground = new ColorDrawable(a.getColor(
                R.styleable.MaterialRippleLayout_rippleBackground, DEFAULT_BACKGROUND));
        ripplePersistent = a.getBoolean(R.styleable.MaterialRippleLayout_ripplePersistent,
                DEFAULT_PERSISTENT);
        rippleInAdapter = a.getBoolean(R.styleable.MaterialRippleLayout_rippleInAdapter,
        ...
        mSuperTouch = a.getBoolean(R.styleable.MaterialRippleLayout_rippleSuperTouch,
                DEFAULT_SUPER_TOUCH);
