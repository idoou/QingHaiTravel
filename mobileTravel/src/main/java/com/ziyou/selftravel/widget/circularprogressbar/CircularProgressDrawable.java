...
import static com.ziyou.selftravel.widget.circularprogressbar.CircularProgressBarUtils.checkAngle;
import static com.ziyou.selftravel.widget.circularprogressbar.CircularProgressBarUtils.checkColors;
import static com.ziyou.selftravel.widget.circularprogressbar.CircularProgressBarUtils.checkNotNull;
import static com.ziyou.selftravel.widget.circularprogressbar.CircularProgressBarUtils.checkPositiveOrZero;
import static com.ziyou.selftravel.widget.circularprogressbar.CircularProgressBarUtils.checkSpeed;
...
public class CircularProgressDrawable extends Drawable implements Animatable {
    ...
    private CircularProgressDrawable(int[] colors, float borderWidth, float sweepSpeed,
            float rotationSpeed,
            int minSweepAngle, int maxSweepAngle, Style style, Interpolator angleInterpolator,
