...
import com.ziyou.selftravel.adapter.HotelListAdapter;
import com.ziyou.selftravel.adapter.NaviListAdapter;
...
import com.ziyou.selftravel.model.HomeHotel;
...
import com.ziyou.selftravel.navi.SimpleNaviActivity;
import com.ziyou.selftravel.navi.Utils;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mPullToRefreshView.setOnRefreshListener(new OnRefreshListener<RecyclerView>() {
            ...
            public void onRefresh(PullToRefreshBase<RecyclerView> refreshView) {
                ...
                mLoader.loadMoreData(NaviListFragment.this, mode);
            }
        });
