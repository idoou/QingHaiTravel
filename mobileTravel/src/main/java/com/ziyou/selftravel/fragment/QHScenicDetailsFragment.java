...
import com.ziyou.selftravel.activity.GuiderRaidersCommentActivity;
...
import com.ziyou.selftravel.activity.TotalComment;
import com.ziyou.selftravel.adapter.ScenicDetailCommentAdapter;
import com.ziyou.selftravel.adapter.WeatherListAdapter;
...
import com.ziyou.selftravel.app.ServerAPI.Favorites;
import com.ziyou.selftravel.app.ServerAPI.ScenicVideos;
...
import com.ziyou.selftravel.model.NearbyPeopleCount;
...
import com.ziyou.selftravel.model.Weather;
...
//        }
        url = "http://182.92.218.24:9000/api/scenics/" + mId + "/";
...
//        }
        ...
        mActionBar.getTitleView().setText(mScenic.name);
//        loadWeatherInfo();
//        loadCommentList();
        // loadNearbyCounts();
    }
