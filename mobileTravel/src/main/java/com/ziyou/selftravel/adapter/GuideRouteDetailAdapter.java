...
public class GuideRouteDetailAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public GuideRouteDetailAdapter() {
    }
    ...
    private Object getItemObj(int position) {
        ...
        for (TripDay day : mTripDetail.days) {
            ...
            count++;
            if (count == position) {
                TripDetailAdapter.CategoryDate date = new TripDetailAdapter.CategoryDate();
                date.date = key;
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        switch (getItemViewType(position)) {
            case TYPE_HEADER:
                ...
                break;
            case TYPE_DATE:
                if (itemObj instanceof TripDetailAdapter.CategoryDate) {
                    RowTripDate.onBindViewHolder(holder, position, (TripDetailAdapter.CategoryDate) itemObj);
                }
                break;
            case TYPE_TRIP_DAY:
                if (itemObj instanceof TripDay) {
//                    RowGuideTripDay.onBindViewHolder(holder, position, (TripDay) itemObj);
                }
                break;
