...
import com.ziyou.selftravel.adapter.row.RowBannerDiscovery;
import com.ziyou.selftravel.adapter.row.RowBannerHome;
import com.ziyou.selftravel.adapter.row.RowBannerNone;
import com.ziyou.selftravel.adapter.row.RowBannerScenic;
import com.ziyou.selftravel.adapter.row.RowBannerVideo;
    ...
    public View getView(int position, View convertView, ViewGroup container) {
        ...
        switch (mScene) {
            ...
            case HOME:
                ...
                break;
            case VIDEO: {
                view = RowBannerVideo.getView(mContext, (Video) bannerSilde, convertView,
                        container,
                        (IActionCallback<Video>) mIActionCallback);
                break;
            }
            default:
