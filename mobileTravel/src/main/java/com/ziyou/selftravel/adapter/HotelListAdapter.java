...
import com.ziyou.selftravel.activity.HotelDetailActivity;
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        if (item.imageUrls.length>0) {
            RequestManager.getInstance().getImageLoader().get(item.imageUrls[0],
                    ImageLoader.getImageListener(viewHolder.rest_img, R.drawable.bg_image_hint,R.drawable.bg_image_hint));
        }
